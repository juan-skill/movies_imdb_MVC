...
// se va a encargar de cumplir ciertas tareas usando el modelo y vistas

MovieController.getAll = (req, res, next) => {

	// MovieModel.getAll = (callback) recibe una callback como parametro
...
MovieController.getOne = (req, res, next) => {
	...
	// MovieModel.getOne = (id, callback) => recibe como parametro el id y una callback
